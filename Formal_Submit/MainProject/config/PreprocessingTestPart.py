...
class Configuration:
    ...
    def __init__(self):
        ...
        self.Preprocessing_count_label = "333"

        self.training_base_dir = r'E:\ACM\OriginalAreaPolygon'

        self.study_area_fn = 'Area_A.gpkg' # 06-19 & 08-25 use this Area

        # self.study_area_fn = 'Area_B.gpkg' # 06-03 & 07-31 use this Area


        self.fishnet_base_dir = r'E:\ACM\PreprocessingResult\FishNet'


        # For reading the VHR images # Very High Resolution
        self.bands = [0,1,2] # 波段
        self.raw_image_base_dir = 'D:\SelfStudy\ACM_contest2023\All_TraningData_Prepare\Image'
        self.raw_image_file_type = '.tif'
        # self.raw_pan_image_prefix = 'Greenland26X_22W_Sentinel2_2019-06-03_05' # 全波段影像
        ...
        self.path_to_write = r'E:\ACM\Final_ChongCi\FinalOutPut\TestPartResult0930_0825_New'
